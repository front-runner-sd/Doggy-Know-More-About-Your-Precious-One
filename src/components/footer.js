  ...
  return (
    <footer>
      <section className={styles.footerTopSection}>
        ...
        <div>
          <a href="https://www.facebook.com/soudip.das.986" target="#">
            <FontAwesomeIcon icon={faFacebook} />
          </a>
          <a href="https://twitter.com/SoudipDas18" target="#">
            <FontAwesomeIcon icon={faTwitter} />
          </a>
          <a href="mailto:iamsoudipdas@gmail.com" target="#">
            <FontAwesomeIcon icon={faGoogle} />
          </a>
          <a href="https://www.instagram.com/i_am_soudip_das" target="#">
            <FontAwesomeIcon icon={faInstagram} />
          </a>
          <a href="https://www.linkedin.com/in/thesoudipdas" target="#">
            <FontAwesomeIcon icon={faLinkedin} />
          </a>
          <a href="https://github.com/front-runner-sd" target="#">
      ...
      <section className={styles.footerMidSection}>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.col_2}>
              ...
              <p>
                <a href='https://weather-app-by-soudip.netlify.app/'target="#"  className={styles.myCreation}>
                  Weather App
                </a>
              </p>
              <p>
